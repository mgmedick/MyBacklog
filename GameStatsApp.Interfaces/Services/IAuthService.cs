...
namespace GameStatsApp.Interfaces.Services
{
    public interface IAuthService
    {
        ...
        Task<TokenResponse> ReAuthenticate(string refreshToken, string redirectUri);
        ...
        Task<List<string>> GetUserGameNames(string userHash, string xstsToken, ulong userXuid);
