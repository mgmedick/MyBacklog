<template>
    <div class="mx-auto">
        ...
        <div class="mx-auto text-center" style="max-width:400px;">   
            ...
            <div class="text-dark mb-3"><span>This is a side project, so it might not get updated frequently. If you have any questions, ideas or bug reports feel free to reach out on our <a href="https://github.com/mgmedick/MyBacklog" class="link-underline-info fw-bold">github</a>.</span></div>
        </div>
    </div>
</template>
<script>    
